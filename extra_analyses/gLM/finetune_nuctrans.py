...
# Train - add ckpt_path since first training timed out
trainer.fit(model, datamodule.train_dataloader.data, datamodule.val_dataloader.data, ckpt_path = 'nuctrans/lightning_logs/version_0/checkpoints/epoch=2-step=661491.ckpt')