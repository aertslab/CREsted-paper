...
def train(adata: anndata.AnnData, run_id: str):
    ...
    optimizer = keras.optimizers.Adam(learning_rate=1e-6) # decreased learning rate
    ...
    trainer = crested.tl.Crested(
        ...
        run_name = run_id + "_finetune",
        logger = 'wandb',
    )

    trainer.load_model(f"PBMC_INPUT_SIZE/{run_id}/checkpoints/{model_f}")
